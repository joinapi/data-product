...
class ProductPriceCond extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'input_param_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'operator_enum_id', 'enum_id');
    }
