...
class ProductConfigOption extends Model
{
     ...
     * @var string
     */
    protected $table = 'product_config_option';

    /**
     * @var array
     */
    protected $fillable = ['config_option_name', 'description', 'sequence_num', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
