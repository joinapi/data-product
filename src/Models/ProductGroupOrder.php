...
class ProductGroupOrder extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\JobSandbox', 'job_id', 'job_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\OrderItemGroupOrder', 'group_order_id', 'group_order_id');
    }
}
