...
class ProductPrice extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Geo', 'tax_auth_geo_id', 'geo_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Party', 'tax_auth_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\CustomMethod', 'custom_price_calc_service', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Uom', 'term_uom_id', 'uom_id');
    }
