...
class ProductStoreFinActSetting extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\FinAccountType', 'fin_account_type_id', 'fin_account_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Survey', 'purchase_survey_id', 'survey_id');
    }
}
