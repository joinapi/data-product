 ...
 */
class FacilityContactMech extends Model
{
     ...
     * @var string
     */
    protected $table = 'facility_contact_mech';

    /**
     * @var array
     */
    protected $fillable = ['thru_date', 'extension', 'comments', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
