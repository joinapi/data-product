...
class ProductAssoc extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\CustomMethod', 'estimate_calc_method', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\RecurrenceInfo', 'recurrence_info_id', 'recurrence_info_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\WorkEffort', 'routing_work_effort_id', 'work_effort_id');
    }
