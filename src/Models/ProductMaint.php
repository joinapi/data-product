...
class ProductMaint extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Uom', 'interval_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\WorkEffort', 'maint_template_work_effort_id', 'work_effort_id');
    }
}
