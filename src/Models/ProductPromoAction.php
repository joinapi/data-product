...
class ProductPromoAction extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Enumeration', 'product_promo_action_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\OrderAdjustmentType', 'order_adjustment_type_id', 'order_adjustment_type_id');
    }
