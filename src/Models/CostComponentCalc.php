...
class CostComponentCalc extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\GlAccountType', 'cost_gl_account_type_id', 'gl_account_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\CustomMethod', 'cost_custom_method_id', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\GlAccountType', 'offsetting_gl_account_type_id', 'gl_account_type_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\WorkEffortCostCalc', 'cost_component_calc_id', 'cost_component_calc_id');
    }
}
