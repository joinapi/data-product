...
class ProductPromoCode extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\OrderProductPromoCode', 'product_promo_code_id', 'product_promo_code_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\ShoppingList', 'product_promo_code_id', 'product_promo_code_id');
    }
}
