...
class ProductGlAccount extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\GlAccount', 'gl_account_id', 'gl_account_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Party', 'organization_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\GlAccountType', 'gl_account_type_id', 'gl_account_type_id');
    }
}
