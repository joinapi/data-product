...
class InventoryItemDetail extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Enumeration', 'reason_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\ShipmentReceipt', 'receipt_id', 'receipt_id');
    }
