...
class ProductMeterType extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\FixedAssetMeter', 'product_meter_type_id', 'product_meter_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Uom', 'default_uom_id', 'uom_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\FixedAssetMaint', 'interval_meter_type_id', 'product_meter_type_id');
    }
}
