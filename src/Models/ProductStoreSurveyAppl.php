...
class ProductStoreSurveyAppl extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\SurveyApplType', 'survey_appl_type_id', 'survey_appl_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Survey', 'survey_id', 'survey_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Product\WorkEffortSurveyAppl', 'survey_id', 'product_store_survey_id');
    }
}
