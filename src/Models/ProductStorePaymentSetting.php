...
class ProductStorePaymentSetting extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\CustomMethod', 'payment_custom_method_id', 'custom_method_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Enumeration', 'payment_service_type_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\PaymentGatewayConfig', 'payment_gateway_config_id', 'payment_gateway_config_id');
    }
